...
//เพิ่มการใช้ฟอนต์ไทย 2 ชนิด CordiaUPC และ JasmineUPC
define("FF_CORDIA", 93);		
define("FF_JASMINE", 94); 		
...
class TTF {
    ...
    function __construct() {
	    ...
	    */
		...
		//ชื่อไฟล์ของฟอนต์ไทยแต่ละรูปแบบ 
		//CordiaUPC
		FF_CORDIA => array(FS_NORMAL=>'cordiau.ttf', FS_BOLD=>'cordiaub.ttf', 
		 								FS_ITALIC=>'cordiaui.ttf', FS_BOLDITALIC=>'cordiauz.ttf'),												
		//JasmineUPC								
		FF_JASMINE => array(FS_NORMAL=>'upcjl.ttf', FS_BOLD=>'upcjb.ttf', 
										 FS_ITALIC=>'upcji.ttf', FS_BOLDITALIC=>'upcjbi.ttf'),
