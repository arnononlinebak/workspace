...
<html style="margin: 0" onMouseDown="top.ICEcoder.mouseDown = true" onMouseUp="top.ICEcoder.mouseDown = false;
        if (!top.ICEcoder.overCloseLink) {
            top.ICEcoder.tabDragEnd()
        }" onMouseMove="if (top.ICEcoder) {
                    top.ICEcoder.getMouseXY(event, 'editor');
                    top.ICEcoder.canResizeFilesW()
                }">
    <head>
        ...
        <link rel="stylesheet" href="<?php
              if ($ICEcoder["theme"] == "default") {
                  ...
                  echo $ICEcoder["codeMirrorDir"] . '/theme/' . $ICEcoder["theme"] . '.css';
              };
        ...
        <script>
            ...
            function createNewCMInstance(num) {
                ...
                window['cM' + num] = CodeMirror(document.body, {
                    ...
                    lintWith: <?php if ($ICEcoder['codeAssist']) {
    echo 'fileName && fileName.indexOf(".js")>-1 ? CodeMirror.javascriptValidator : ';
}; ?>false,
                    keyMap: "ICEcoder",
