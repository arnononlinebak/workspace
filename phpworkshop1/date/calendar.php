...
<body>
  <table border="1">
	<tr bgcolor="#BBBBBB">
		...
		<a href="calendar.php?month=<?=$m_back?>&year=<?=$y_back?>"> << </a> 
		<? echo "$full_month $year"; ?>
		<a href="calendar.php?month=<?=$m_next?>&year=<?=$y_next?>"> >> </a>
		</b></center></td>
	</tr>
    <tr bgcolor="#BBBBBB">
     <td>Sun</td>
...
$y_today=date('Y');
?>
		<a href="calendar.php?mouth=<?=$m_today?>&year=<?=$y_today?>">Today</a>
		</center></td>
</tr>	
</table>
</body>
