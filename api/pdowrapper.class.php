...
class Database extends PDO
{
	...
	*/
	public function __construct($db, $dbHost = false, $dbName = false, $dbUser = false, $dbPass = false)
	{
		...
		/** Construct using the variables */
		else
		{
			parent::__construct("$db:host=$dbHost;dbname=$dbName", $dbUser, $dbPass);
		}
	...
	*/
	public function select($select, $fromTable, $where = NULL)
	{
		/** Reset the currentSelect values so a fresh set will be placed in */
		$this->_currentSelect = NULL;
